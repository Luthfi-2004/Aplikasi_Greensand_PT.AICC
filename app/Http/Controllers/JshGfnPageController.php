...
class JshGfnPageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('jshgfn.index', ['date' => $date, 'shift' => $shift])
            ->with('status', 'Data GFN berhasil disimpan.');
    }

    // perbarui data (boleh tanggal lampau)
    public function update(Request $request)
    {
        ...
        $existsAny = TotalGfn::whereDate('gfn_date', $gfnDate)
            ->where('shift', $shift)
            ->exists();
        ...
        DB::transaction(function () use ($gfnDate, $shift, $grams, $percentages, $percentageIndices, $totalGram, $sumPI) {
            JshGfn::whereDate('gfn_date', $gfnDate)->where('shift', $shift)->delete();
            TotalGfn::whereDate('gfn_date', $gfnDate)->where('shift', $shift)->delete();
    ...
    public function deleteTodaySet(Request $request)
    {
        ...
        $exists = TotalGfn::whereDate('gfn_date', $gfnDate)
            ->where('shift', $shift)
            ->exists();
